...
Public Class frmArtiesten
    ...
    Private Sub LoadArtists()
        ...
        mysql = "select ArtistName from ArtistUK order by ArtistName"
        datemp = New OleDbDataAdapter
        datemp.SelectCommand = New OleDbCommand(mysql, myconnection1)
        datemp.Fill(dstemp, "ArtistUK")
    ...
    Private Sub LoadAltcoins(ByVal num As Integer)
        ...
        Me.Text = "UK POP Artists and Hits Search Artists"
