...
Public Class frmImportLijstenUK
    ...
    Private BaseURLTop40 As String = "http://www.officialcharts.com/charts/uk-top-40-singles-chart/"
    ...
    Private Sub RemoveCMCoins()
        ...
        'my_sql = "delete from CurrencyName where 1=1"
    ...
    Private Sub LoadAltcoins(ByVal num As Integer)
        ...
        If KoersNum = 0 Then
            mysql = "select Listid,nr01,nr02,nr03 from Top40ListNumbersUK order by Listid"
            Me.Text = "Import UK Top40 Lists"
        ...
        Try
            ...
            'get listnumber
            test_sql = "Select max(Listid) from Top40ListNumbersUK"
            ...
            'get year 
            test_sql = "Select listyear from Top40ListUK where id = " + TheList.ToString()
            mycommand.CommandText = test_sql
            myret = mycommand.ExecuteScalar()
            TheYear = myret

            'get week
            test_sql = "Select week from Top40ListUK where id = " + TheList.ToString()
            mycommand.CommandText = test_sql
            myret = mycommand.ExecuteScalar()
            TheWeek = myret

            test_sql = "Select hitdate from UKWeeks where hityear = " + TheYear.ToString() + " and hitweek = " + TheWeek.ToString()
            mycommand.CommandText = test_sql
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'Get Updates from CCC
        'MyResults = webClient.DownloadString("http://www.cryptocoincharts.info/v2/api/listCoins")
        'TextBox1.Text = MyResults

        Dim rc As Integer

        'rc = MsgBox("All coins will be imported from textbox !!! Press OK to confirm !!!", MsgBoxStyle.OkCancel)
        'If rc = 1 Then
    ...
    Private Function CM1SongToDatagrid(ByVal MyResults As String, ByVal MyIndex As Integer, ByVal SongNum As Integer) As Integer
        ...
        start1 = ind1
        ind2 = MyResults.IndexOf(vbCrLf, start1)
        AltcoinStr = MyResults.Substring(ind1, ind2 - ind1 - 1)
        Name = AltcoinStr

        'Correct the last lines until Peak pos,WOC
        ind1 = ind2 + 4
        start1 = ind1
        ind2 = MyResults.IndexOf(vbCrLf, start1)
        AltcoinStr = MyResults.Substring(ind1, ind2 - ind1)
    ...
    Private Function CMSongstoDatagrid() As Integer
        ...
        ind1 = 0
        start1 = ind1
        ind2 = MyResults.IndexOf("WoC", start1)
        ind1 = ind2 + 1
        start1 = ind1
    ...
    Private Sub InsertCMCoins()
        ...
        'Insert all 40 songs
        my_sql = "insert into Top40ListNumbersUK values ("
        ...
        my_sql = "insert into Top40ListUK values (" + lijstnr.ToString() + ",'" + TheYear + "','" + TheWeek + "','" + TheArtist + "','" + TheName + "','" + TheSong + "')"
        mycommand.CommandText = my_sql
        mycommand.ExecuteNonQuery()

        test_sql = "Select max(songid) from SongUK"
        mycommand.CommandText = test_sql
        myret = mycommand.ExecuteScalar()
        MySongId = myret + 1
        ...
        For i = 0 To 39
            ...
            test_sql = "Select count(*) from ArtistUK where ArtistName = '" + TheArtist + "'"
            mycommand.CommandText = test_sql
            myret = mycommand.ExecuteScalar()
            ...
            Else
                ...
                my_sql = "insert into ArtistUK(ArtistName) values ('" + TheArtist + "')"  ' artist name
                mycommand.CommandText = my_sql
                mycommand.ExecuteNonQuery()
            End If

            test_sql = "Select count(*) from SongUK where Artist = '" + TheArtist + "' AND SongName = '" + TheName + "'"
            mycommand.CommandText = test_sql
            myret = mycommand.ExecuteScalar()
            ...
            Else
                'insert the new artist
                my_sql = "insert into SongUK(SongId,SongName,Artist,Hitname,SongYear) values (" + MySongId.ToString() + ",'" + TheName + "','" + TheArtist + "','" + TheSong + "','" + TheYear + "')"
                mycommand.CommandText = my_sql
                mycommand.ExecuteNonQuery()
                MySongId = MySongId + 1
    ...
    Private Sub CopyWebpage()
        ...
        Try
            ...
            myyear = tbYEAR.Text
            myweek = tbWEEK.Text
            test_sql = "Select hitdate from UKWeeks where hityear = " + myyear + " and hitweek = " + myweek
            mycommand.CommandText = test_sql
            myhitdate = mycommand.ExecuteScalar()
            myconnection1.Close()


            myurl = BaseURLTop40 + myyear + myhitdate + "/750140/"
            tbURL.Text = myurl
